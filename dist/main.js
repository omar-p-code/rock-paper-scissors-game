...
let rulesBtn = document.querySelector('.rules .rules-btn');
let rules = document.querySelector('.rules-modal');
let rulesClose = document.querySelector('.rules-modal .close-btn svg');
...
let gameElements = Array.from(document.querySelectorAll('.game .polygon .ele'));
gameElements.forEach((ele) => {
    ele.addEventListener('click', (event) => {
        let selectedElement = event.currentTarget.classList[0];
        let computerElement = getRandomElement();
        ...
        setTimeout(() => {
            let result = determineWinner(selectedElement, computerElement);
...
function displayPlayer(player) {
    let playerEle = document.querySelector('.game .action .player .icon');
...
function displayComputer(computer) {
    let computerEle = document.querySelector('.game .action .computer .icon');
...
function displayResult(result) {
    let resultText = document.querySelector('.game .result-text');
